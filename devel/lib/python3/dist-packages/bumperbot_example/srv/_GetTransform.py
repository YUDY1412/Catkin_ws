...
"""autogenerated by genpy from bumperbot_example/GetTransformRequest.msg. Do not edit."""
import codecs
import sys
...
class GetTransformRequest(genpy.Message):
  ...
  _type = "bumperbot_example/GetTransformRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bumperbot_example/GetTransformResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetTransformResponse(genpy.Message):
  _md5sum = "9d8d8f59ba11a2427054ac0f636df9d1"
  _type = "bumperbot_example/GetTransformResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#Response
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dB().pack(_x.transform.transform.translation.x, _x.transform.transform.translation.y, _x.transform.transform.translation.z, _x.transform.transform.rotation.x, _x.transform.transform.rotation.y, _x.transform.transform.rotation.z, _x.transform.transform.rotation.w, _x.succeed))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.transform.transform.translation.x, _x.transform.transform.translation.y, _x.transform.transform.translation.z, _x.transform.transform.rotation.x, _x.transform.transform.rotation.y, _x.transform.transform.rotation.z, _x.transform.transform.rotation.w, _x.succeed,) = _get_struct_7dB().unpack(str[start:end])
...
class GetTransform(object):
  _type          = 'bumperbot_example/GetTransform'
  _md5sum = 'cd915af3643e080e81d0d0cf82efa933'
