...
(cl:in-package bumperbot_example-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bumperbot_example-srv:<GetTransform-request> is deprecated: use bumperbot_example-srv:GetTransform-request instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <GetTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bumperbot_example-srv:frame_id-val is deprecated.  Use bumperbot_example-srv:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'child_frame_id-val :lambda-list '(m))
(cl:defmethod child_frame_id-val ((m <GetTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bumperbot_example-srv:child_frame_id-val is deprecated.  Use bumperbot_example-srv:child_frame_id instead.")
  (child_frame_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTransform-request>)))
  ...
  "bumperbot_example/GetTransformRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform-request)))
  "Returns string type for a service object of type 'GetTransform-request"
  "bumperbot_example/GetTransformRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetTransform-request>)))
  ...
  "cd915af3643e080e81d0d0cf82efa933")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetTransform-request)))
  "Returns md5sum for a message object of type 'GetTransform-request"
  "cd915af3643e080e81d0d0cf82efa933")
...
(cl:defmethod cl:initialize-instance :after ((m <GetTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bumperbot_example-srv:<GetTransform-response> is deprecated: use bumperbot_example-srv:GetTransform-response instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <GetTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bumperbot_example-srv:transform-val is deprecated.  Use bumperbot_example-srv:transform instead.")
  (transform m))

(cl:ensure-generic-function 'succeed-val :lambda-list '(m))
(cl:defmethod succeed-val ((m <GetTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bumperbot_example-srv:succeed-val is deprecated.  Use bumperbot_example-srv:succeed instead.")
  (succeed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTransform-response>)))
  ...
  "bumperbot_example/GetTransformResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform-response)))
  "Returns string type for a service object of type 'GetTransform-response"
  "bumperbot_example/GetTransformResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTransform)))
  ...
  "bumperbot_example/GetTransform")